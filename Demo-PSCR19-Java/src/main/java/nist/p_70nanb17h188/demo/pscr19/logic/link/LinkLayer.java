...
public class LinkLayer {
    ...
    /**
     * Broadcast intent action indicating that a link is either established or
     * disconnected. One extra EXTRA_NEIGHBOR_ID indicates the ID of the
     * neighbor. Another extra EXTRA_CONNECTED indicates if the connection is
    ...
    /**
     * Broadcast intent action indicating that a piece of data is received. One
     * extra EXTRA_NEIGHBOR_ID indicates the ID of the neighbor that sent the
     * data. Another extra EXTRA_DATA contains the data sent.
     */
